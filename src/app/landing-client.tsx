  ...
  return (
    <div className="page on" style={{ paddingTop: 0, position: "relative", minHeight: "100vh" }}>
      ...
      <section style={{
        ...
        position: "relative", zIndex: 1, width: "100%", gap: 0,
      }}>
        <motion.div
          initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="bc-hero-eyebrow" style={{ marginBottom: 36 }}
        >
        ...
        <motion.h1
          ...
          style={{
            ...
            fontSize: "clamp(42px, 6vw, 76px)", fontWeight: 900,
            lineHeight: 1.05, letterSpacing: "-2.5px", marginBottom: 0, maxWidth: 1000,
          }}
        >
          <span style={{ display: "block", color: "var(--t)" }}>Temukan partner</span>
          <span style={{
            display: "block",
        ...
        <motion.div
          ...
          className="bc-proof" style={{ justifyContent: "center", marginBottom: 64 }}
        >
        ...
        <motion.div
          ...
          style={{
            ...
            color: "var(--t3)", fontSize: 10, fontWeight: 700, letterSpacing: "1.5px", textTransform: "uppercase",
          }}
        >
      ...
      <div className="marquee-wrap" style={{ position: "relative", zIndex: 1 }}>
        <div className="marquee">
          ...
          <span className="mq-item"><i className="ph-fill ph-users lc mq-icon"></i><b>{formatStat(stats.teams)} tim</b> terbentuk di BeeMate</span><span className="mq-sep">·</span>
          <span className="mq-item"><i className="ph-fill ph-trophy lc mq-icon"></i><b>Team Nexus</b> juara 1 Gemastik XVI</span><span className="mq-sep">·</span>
          <span className="mq-item"><i className="ph-fill ph-medal lc mq-icon"></i><b>Visual Crew</b> runner-up COMPFEST UI/UX</span><span className="mq-sep">·</span>
          <span className="mq-item"><i className="ph-fill ph-rocket-launch lc mq-icon"></i><b>EduTrack</b> startup live 2K+ users</span><span className="mq-sep">·</span>
          <span className="mq-item"><i className="ph-fill ph-check-circle lc mq-icon"></i><b>PKM-KC EcoSmart</b> didanai Dikti 2024</span><span className="mq-sep">·</span>
      ...
      <section className="testi-col-section">
        ...
        <div className="testi-col-mask">
          ...
          <TestimonialsColumn testimonials={col2} duration={22} className="testi-col-mask-col2" />
        ...
        >
          <div style={{ flex: 1 }}>
            ...
            <div className="cta-sub">
              Bergabung dengan {formatStat(stats.users)} Binusians yang sudah menemukan partner terbaik mereka di BeeMate.
            </div>
          </div>
